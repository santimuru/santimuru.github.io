const translations = {
  en: {
    ...
    'about.bio2': 'Currently in Tokyo as Lead BI Analyst at Montecable, focused on churn prediction, fraud analytics and BI migration. The specific numbers are in the Experience section below.',
  ...
  es: {
    ...
    'about.bio2': 'Hoy en Tokio como Analista BI Líder en Montecable, enfocado en predicción de churn, analítica de fraude y migración de BI. Los números concretos están en la sección Experiencia.',
  ...
  ja: {
    ...
    'about.bio2': '現在は東京で、MontecableのリードBIアナリストとして、解約予測・不正分析・BI移行に取り組んでいます。具体的な数字は下の職務経歴セクションをご覧ください。',
